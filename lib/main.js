  ...
  Main = (function() {
    ...
    Main.prototype.htmlElements = function() {
      ...
      $('#example2').bind('click', function() {
        return _this.configure(new Curve("c1", [[731, 149], [230, 40], [29, 266], [143, 449], [33, 33]]));
      });
      $('#example3').bind('click', function() {
        return _this.configure(new Curve("c1", [[731, 149], [230, 40], [29, 266], [143, 449], [33, 33], [66, 66], [99, 99]]));
      });
      return $('#example4').bind('click', function() {
        return _this.configure(new Curve("c1", [[731, 149], [230, 40], [29, 266], [143, 449], [33, 33], [66, 66], [99, 99], [111, 111], [133, 133]]));
      });
    };
